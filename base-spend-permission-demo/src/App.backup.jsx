            ...
            >
              Learn more about Base
                        ...
                        loading 
                          ...
                          : 'bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 shadow-lg hover:shadow-blue-500/20'
                  ...
                  <div className="space-y-8 animate-fade-in">
                    ...
                    <div className="space-y-4" variants={itemVariants}>
                      <div className="flex items-center space-x-3">
                        <div className={`flex-shrink-0 flex items-center justify-center w-9 h-9 rounded-full transition-all ${step >= 1 ? 'bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400' : 'bg-slate-100 text-slate-400 dark:bg-slate-800'}`}>
                      ...
                      <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl space-y-4 border border-slate-100 dark:border-slate-700/50">
                        <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-800/80 rounded-xl border border-slate-100 dark:border-slate-700/50 shadow-sm hover:shadow transition-shadow">
                          <div className="flex items-center space-x-3">
                            <div className="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg shadow-inner">
                              <FiUser className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                            </div>
                            <div>
                              <p className="text-xs font-medium text-slate-500 dark:text-slate-400">Your Wallet</p>
                              <p className="font-mono text-sm font-medium text-slate-800 dark:text-slate-200">{formatAddress(account)}</p>
                            </div>
                          </div>
                          <button 
                            onClick={() => copyToClipboard(account)}
                            className="p-2 text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 rounded-full hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors"
                            title="Copy address"
                          >
                            {copied ? (
                              <FiCheck className="w-4 h-4 text-green-500" />
                        ...
                        <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-800/80 rounded-xl border border-slate-100 dark:border-slate-700/50 shadow-sm hover:shadow transition-shadow">
                          <div className="flex items-center space-x-3">
                            <div className="p-2 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg shadow-inner">
                              <FiShield className="w-5 h-5 text-indigo-600 dark:text-indigo-400" />
                            </div>
                            <div>
                              <p className="text-xs font-medium text-slate-500 dark:text-slate-400">Backend Wallet</p>
                              <p className="font-mono text-sm font-medium text-slate-800 dark:text-slate-200">{formatAddress(BACKEND_WALLET)}</p>
                            </div>
                          </div>
                          <button 
                    ...
                    <div className="space-y-4" variants={itemVariants}>
                      <div className="flex items-center space-x-3">
                        <div className={`flex-shrink-0 flex items-center justify-center w-9 h-9 rounded-full transition-all ${step >= 2 ? 'bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400' : 'bg-slate-100 text-slate-400 dark:bg-slate-800'}`}>
                          <span className="font-medium text-sm">2</span>
                        </div>
                        <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">Set Allowance</h3>
                      </div>
                      
                      <div className="bg-slate-50 dark:bg-slate-800/50 p-5 rounded-xl border border-slate-100 dark:border-slate-700/50">
                        <div className="mb-5">
                          <label htmlFor="allowance" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                            ETH per 30 days
                          </label>
                          <div className="relative">
                            <input
                              ...
                              step="0.001"
                              min="0.00009"
                              className="w-full px-12 py-3.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500/50 dark:focus:border-blue-500 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 transition-all duration-200"
                              placeholder="0.00009"
                            />
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                              <FiDollarSign className="h-5 w-5 text-slate-400 dark:text-slate-500" />
                            </div>
                            <div className="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                              <span className="text-slate-500 dark:text-slate-400 text-sm font-medium">ETH</span>
                            </div>
                          </div>
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl flex items-start border border-blue-100 dark:border-blue-900/30">
                          <FiClock className="flex-shrink-0 h-5 w-5 text-blue-500 dark:text-blue-400 mt-0.5" />
                          <p className="ml-3 text-sm text-blue-700 dark:text-blue-300">
                            This permission will be valid for 30 days from the time of creation.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Action Buttons */}
                    <div className="pt-2" variants={itemVariants}>
                      <button
                        onClick={handleCreatePermission}
                        disabled={loading || permission}
                        className={`w-full px-6 py-4 rounded-xl font-medium text-white transition-all duration-300 transform hover:scale-[1.02] ${
                          loading || permission 
                      ...
                      <p className="mt-3 text-xs text-center text-slate-500 dark:text-slate-400">
                        You'll be prompted to sign a message in your wallet
                      </p>
                    </div>
                  </div>
                )}
              ...
              <div className="space-y-6 p-6 md:p-8">
                <div className="text-center py-4">
                  <div className="mx-auto w-20 h-20 bg-green-100 dark:bg-green-900/30 rounded-2xl flex items-center justify-center mb-6 shadow-inner">
                    <FiCheckCircle className="w-10 h-10 text-green-600 dark:text-green-400" />
                  </div>
                  <h3 className="text-2xl font-bold text-slate-800 dark:text-white mb-3">Permission Created</h3>
                  <p className="text-slate-600 dark:text-slate-300 max-w-md mx-auto">
                    Your spend permission has been successfully created and signed.
                  </p>
                </div>

                <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-6 space-y-6 border border-slate-100 dark:border-slate-700/50">
                  <div className="space-y-4">
                    <h4 className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Permission Details</h4>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center p-3 bg-white dark:bg-slate-800/80 rounded-lg border border-slate-100 dark:border-slate-700/50">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm font-medium text-slate-700 dark:text-slate-300">User Address</span>
                        </div>
                        <div className="flex items-center">
